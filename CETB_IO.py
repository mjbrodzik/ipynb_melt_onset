...
def get_site_boundaries(SiteLabel):
    ...
    dict = {
        ...
        'GreatLakes':{
            ...
            'lon_end':-89.861310},
        'LakeEldora':{
            'Site': 'Lake Eldora_SNOTEL (Storm), CO', 
            'lat_start': 39.94,
            'lon_start':-105.59,
            'lat_end':39.94,
            'lon_end':-105.59},
        'Denver':{
            'Site': 'Denver (Storm), CO', 
            'lat_start': 39.7392,
            'lon_start':-104.985,
            'lat_end':39.7392,
            'lon_end':-104.985},
 ...
 #Note is within the same GRD as the airport       
        ...
        'SNOTEL9':{
            ...
            'lon_end':-145.4},
        'TestAK':{
            'Site':' Test Site >66°N, AK', #, near Fairbanks, AK for Melt Threshold Optimization project_Mahboubeh',
            'lat_start':63.5,
            'lon_start':-145.5,
            'lat_end':63.5,
            'lon_end':-145.5},
        'TestAK_2':{
            ...
            'lon_end':-145.5},
        'TestAK_3':{
            'Site':'Test Site', #, near Fairbanks, AK for Melt Threshold Optimization project_Mahboubeh',
            'lat_start':63.73622572,
            'lon_start':-143.0869719,
            'lat_end':63.73622572,
            'lon_end':-143.0869719},
        ...
        'AlaskaGlacier':{
            ...
            'lon_start':-148.8,
            'lon_end':-147.6  ,
            'Site':'Matanuska Glacier, AK'},
        'Alaska1':{
            'Site':'Alaska Box1', 
            'lat_start':66.626583, 
            'lon_start':-150.660413, 
            'lat_end':70.721585, 
            'lon_end':-139.65842},
        'Alaska2':{
            'Site':'Alaska Box2', 
            'lat_start':64.107919, 
            'lon_start':-149.619863, 
            'lat_end':66.65615, 
            'lon_end':-140.110501},
        'Alaska3':{
            'Site':'Alaska Box3', 
            'lat_start':61.633996, 
            'lon_start':-149.111028, 
            'lat_end':64.107919, 
            'lon_end':-140.379788},
        'Alaska4':{
            'Site':'Alaska Box4', 
            'lat_start':59.366923, 
            'lon_start':-148.427503, 
            'lat_end':61.633996, 
            'lon_end':-140.602387},
        'Alaska5':{
            'Site':'Alaska Box5',
        ...
        'Alaska6':{
            'Site':'Alaska Box6', 
            'lat_start':63.598784, 
            'lon_start':-156.913863, 
            'lat_end':66.65615, 
            'lon_end':-149.111028},
        'Alaska7':{
            'Site':'Alaska Box7', 
            'lat_start':60.912983, 
            'lon_start':-155.556787, 
            'lat_end':63.948332, 
            'lon_end':-148.427503},
        'Alaska8':{
            'Site':'Alaska Box8', 
            'lat_start':55.951411, 
            'lon_start':-154.556352, 
            'lat_end':61.633996, 
            'lon_end':-148.327369},
        'Alaska9':{
            'Site':'Alaska Box9', 
            'lat_start':65.011635, 
            'lon_start':-169.249134, 
            'lat_end':71.462506, 
            'lon_end':-156.913863},
        'Alaska10':{
            'Site':'Alaska Box10', 
            'lat_start':62.035447, 
            'lon_start':-167.513709, 
            'lat_end':66.326666, 
            'lon_end':-155.556787},
        'Alaska11':{
            'Site':'Alaska Box11',
            'lat_start':59.033415,
            'lon_start':-168.040245,
            'lat_end':63.598784,
            'lon_end':-154.556352},
        'Alaska12':{
            'Site':'Alaska Box12',
            ...
            'lon_end':-154.556352},
        'CentralAK':{
            'Site':'Alaska Center for Test',
            'lat_start': 63.033003,
            'lon_start':-152.102448,
            'lat_end': 68.911690,
            'lon_end':-140.265871},
        'AKYukan':{
            'Site':'AKYukan Cube',
        ...
        'BannerSummit':{      	
            ...
            'lon_end':-115.23447},
        'DeadwoodSummit':{ 	
            'Site':'Deadwood Summit',
            'lat_start':44.54492,
            'lon_start':-115.56386,
            'lat_end':44.54492,
            'lon_end':-115.56386},
        'GrahamGuardSta':{ 	
            'Site':'Graham Guard Sta.',
            'lat_start':43.9538,
            'lon_start':-115.27387,
            'lat_end':43.9538,
            'lon_end':-115.27387},
        'MoresCreekSummit':{	
            'Site':'Mores Creek Summit',
            'lat_start':43.932,
            'lon_start':-115.66588,
            'lat_end':43.932,
            'lon_end':-115.66588},
     ...
     #Western_CA Sites
        ...
        'GreatSlaveLake':{
            ...
            'lon_end':-114.05},
        'Caribou':{
            'Site':'New Caribou Spring Migration',
            'lat_start':57.621465,
            'lon_start':-117.8405671,
            'lat_end':62.2624419,
            'lon_end':-98.4793464},
        'Cube44':{
            'Site':'New Cube Check',
            'lat_start':51.22769221617612,
            'lon_start':-161.565051177078,
            'lat_end':77.31051225902667,
            'lon_end':-108.434948822922},
         #GLAIL Sites
